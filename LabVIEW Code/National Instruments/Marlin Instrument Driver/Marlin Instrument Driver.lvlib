...
3D printers running Marlin Firmware e.g. Creality printers.</Property>
	...
	<Item Name="Private" Type="Folder">
		...
		<Item Name="Serial read all.vi" Type="VI" URL="../Private/Serial read all.vi"/>
	</Item>
	<Item Name="Public" Type="Folder">
		<Property Name="NI.LibItem.Scope" Type="Int">1</Property>
		<Property Name="NI.SortType" Type="Int">3</Property>
		<Item Name="Configure" Type="Folder">
			<Item Name="Positioning.vi" Type="VI" URL="../Public/Configure/Positioning.vi"/>
		...
		<Item Name="Data" Type="Folder">
			...
			<Item Name="Report temperatures.vi" Type="VI" URL="../Public/Data/Report temperatures.vi"/>
			<Item Name="Get Endstop Status.vi" Type="VI" URL="../Public/Data/Get Endstop Status.vi"/>
		</Item>
		<Item Name="Utility" Type="Folder">
			<Item Name="Utility.mnu" Type="Document" URL="/&lt;instrlib&gt;/Marlin Instrument Driver/Public/Utility/Utility.mnu"/>
			<Item Name="Home.vi" Type="VI" URL="../Public/Utility/Home.vi"/>
			<Item Name="Send raw Gcode.vi" Type="VI" URL="../Public/Utility/Send raw Gcode.vi"/>
			<Item Name="Disable steppers.vi" Type="VI" URL="../Public/Utility/Disable steppers.vi"/>
			<Item Name="Set fan speed.vi" Type="VI" URL="../Public/Utility/Set fan speed.vi"/>
			<Item Name="Set temperature.vi" Type="VI" URL="../Public/Utility/Set temperature.vi"/>
			<Item Name="Move.vi" Type="VI" URL="../Public/Utility/Move.vi"/>
		</Item>
		<Item Name="controls" Type="Folder">
			<Item Name="axes.ctl" Type="VI" URL="../Public/controls/axes.ctl"/>
			<Item Name="move parameters.ctl" Type="VI" URL="../Public/controls/move parameters.ctl"/>
			<Item Name="temperatures.ctl" Type="VI" URL="../Public/controls/temperatures.ctl"/>
			<Item Name="end stop status.ctl" Type="VI" URL="../Public/controls/end stop status.ctl"/>
			<Item Name="heater.ctl" Type="VI" URL="../Public/controls/heater.ctl"/>
		</Item>
